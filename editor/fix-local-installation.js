...
// Edit node_modules/@lightningchart/lcjs-themes package.json version to be something random
// otherwise React seems to use some old version from cache (if build was remade but version is still marked same)

const pathPackageJson = path.resolve('node_modules', '@lightningchart', 'lcjs-themes', 'package.json')
