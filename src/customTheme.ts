...
export const makeCustomTheme = (options: CustomThemeOptions): Theme => {
    ...
    const labelShadow: Color | undefined = options.isDark ? ColorRGBA(20, 20, 20, 255) : ColorRGBA(40, 40, 40, 255)
    const contourLabelShadow: Color | undefined = ColorRGBA(20, 20, 20, 255)
    const titleShadow: Color | undefined = undefined
    ...
    const polarNumericTickStrategy = new NumericTickStrategy({
        extremeTickStyle: emptyTick,
        majorTickStyle: tickStyleMajor
            .setLabelFillStyle(options.isDark ? textFillStyle : blackFillStyle)
            .setLabelShadow(options.isDark ? labelShadow : colorWhite),
        minorTickStyle: tickStyleMinor
            .setLabelFillStyle(options.isDark ? textFillStyle : blackFillStyle)
            .setLabelShadow(options.isDark ? labelShadow : colorWhite),
    })
    ...
    const polarDateTimeTickStrategy = new DateTimeTickStrategy({
        greatTickStyle: emptyTick,
        majorTickStyle: tickStyleMajor
            .setLabelFillStyle(options.isDark ? textFillStyle : blackFillStyle)
            .setLabelShadow(options.isDark ? labelShadow : colorWhite),
    ...
    const polarTimeTickStrategy = new TimeTickStrategy({
        majorTickStyle: tickStyleMajor
            .setLabelFillStyle(options.isDark ? textFillStyle : blackFillStyle)
            .setLabelShadow(options.isDark ? labelShadow : colorWhite),
        minorTickStyle: tickStyleMinor
    ...
    const flatTheme: Theme = {
        ...
        chartXYTitleShadow: titleShadow,
        ...
        heatmapGridSeriesContourStrokeStyle: new SolidLine({ thickness: 1, fillStyle: new SolidFill({ color: ColorRGBA(0, 0, 0) }) }),
        heatmapGridSeriesContourLabelColor: colorWhite,
        heatmapGridSeriesContourLabelFont: fontOther,
        heatmapGridSeriesContourLabelShadow: contourLabelShadow,
        ...
        barChartTitleShadow: titleShadow,
        ...
        barChartValueLabelsInsideBars: {
            position: 'inside-bar',
            formatter: (info) => info.chart.valueAxis.formatValue(info.value),
            labelFillStyle: isDark ? textFillStyle : whiteFillStyle,
            labelFont: numericTickStrategy.majorTickStyle.labelFont,
            labelMargin: 8,
            labelRotation: 0,
            labelAlignment: 0,
        ...
        chart3DTitleShadow: titleShadow,
        ...
        polarChartTitleShadow: titleShadow,
        ...
        polarAmplitudeAxisTitleFillStyle: isDark ? textFillStyle : blackFillStyle,
        polarAmplitudeAxisTitleShadow: isDark ? labelShadow : colorWhite,
        polarAmplitudeAxisStrokeStyle: axisStrokeStyle,
        polarAmplitudeAxisNumericTicks: polarNumericTickStrategy,
        polarAmplitudeAxisDateTimeTicks: polarDateTimeTickStrategy,
        polarAmplitudeAxisTimeTicks: polarTimeTickStrategy,
        ...
        mapChartTitleShadow: titleShadow,
        ...
        dataGridTitleShadow: titleShadow,
        dataGridTextShadow: titleShadow,
        ...
        spiderChartTitleShadow: titleShadow,
        ...
        spiderChartScaleLabelFillStyle: isDark ? textFillStyle : blackFillStyle,
        spiderChartScaleLabelShadow: isDark ? labelShadow : colorWhite,
        ...
        pieChartTitleShadow: titleShadow,
        ...
        pieChartSliceLabelShadow: titleShadow,
        pieChartSliceLabelInsideFillStyle: isDark ? textFillStyle : blackFillStyle,
        pieChartSliceLabelInsideShadow: isDark ? labelShadow : colorWhite,
        ...
        funnelChartTitleShadow: titleShadow,
        ...
        funnelChartSliceLabelShadow: titleShadow,
        funnelChartSliceLabelInsideFillStyle: isDark ? textFillStyle : blackFillStyle,
        funnelChartSliceLabelInsideShadow: isDark ? labelShadow : colorWhite,
        ...
        pyramidChartTitleShadow: titleShadow,
        ...
        pyramidChartSliceLabelShadow: titleShadow,
        pyramidChartSliceLabelInsideFillStyle:  isDark ? textFillStyle : blackFillStyle,
        pyramidChartSliceLabelInsideShadow: isDark ? labelShadow : colorWhite,
        ...
        gaugeChartNeedleFillStyle: whiteFillStyle,
        ...
        gaugeChartTitleShadow: titleShadow,
        linearGaugeChartTitleShadow: titleShadow,
        linearGaugeChartValueLabelFillStyle: textFillStyle,
        linearGaugeChartTickFillStyle: textFillStyle,
        linearGaugeChartTickShadow: titleShadow,
        linearGaugeChartValueLabelShadow: titleShadow,
        linearGaugeChartRoundedEdges: true,
        linearGaugeChartColorInterpolation: false,
        linearGaugeChartGradients: true,
        linearGaugeChartBackgroundFillStyle: chartBackgroundFillStyle,
        linearGaugeChartBackgroundStrokeStyle: emptyLine,
        linearGaugeChartTitleFont: fontChartTitles,
        linearGaugeChartTitleFillStyle: textFillStyle,
        linearGaugeChartTickMargin: 5,
        linearGaugeChartValueLabelFont: fontOther.setSize(28),
        linearGaugeChartTickFont: fontOther.setSize(20),
        linearGaugeChartValueLabelAlignment: 1.5,
        linearGaugeChartBarThickness: 50,
        linearGaugeChartBarStrokeStyle: new SolidLine({ thickness: 1, fillStyle: isDark ? whiteFillStyle : blackFillStyle }),
        linearGaugeChartValueMarkerAlignment: 1,
        linearGaugeChartValueMarkerShape: PointShape.Minus,
        linearGaugeChartValueMarkerSize: 15,
        linearGaugeChartValueMarkerRotationVertical: 0,
        linearGaugeChartValueMarkerRotationHorizontal: 90,
        linearGaugeChartValueMarkerStrokeStyle: new SolidLine({ thickness: 1, fillStyle: blackFillStyle }),
        linearGaugeChartDefaultRangeColor: options.dataColors[0],
        ...
        treeMapChartTitleShadow: titleShadow,
        treeMapChartTitleFont: fontChartTitles,
        treeMapChartPathLabelFillStyle: textFillStyle,
        treeMapChartPathLabelFont: fontOther,
        treeMapChartPathLabelShadow: titleShadow,
        treeMapChartLabelHeaderFillStyle: isDark ? textFillStyle : blackFillStyle,
        treeMapChartLabelHeaderShadow: isDark ? labelShadow : titleShadow,
        treeMapChartLabelHeaderFont: fontOther.setWeight('bold'),
        treeMapChartLabelFillStyle: isDark ? textFillStyle : blackFillStyle,
        treeMapChartLabelShadow: isDark ? labelShadow : titleShadow,
        treeMapChartLabelFont: fontOther,
        treeMapChartCornerRadius: 8,
        sunBurstChartBackgroundFillStyle: chartBackgroundFillStyle,
        sunBurstChartBackgroundStrokeStyle: emptyLine,
        sunBurstChartParentColor: isDark ? ColorRGBA(24, 30, 33) : ColorRGBA(217, 217, 217),
        sunBurstChartNodeColors: options.dataColors.map((color) => color.setA(125)),
        sunBurstChartNodeStrokeStyle: new SolidLine({ thickness: 1, fillStyle: new SolidFill({ color: ColorRGBA(0, 0, 0) }) }),
        sunBurstChartTitleFillStyle: textFillStyle,
        sunBurstChartTitleShadow: titleShadow,
        sunBurstChartTitleFont: fontChartTitles,
        sunBurstChartPathLabelFillStyle: textFillStyle,
        sunBurstChartPathLabelShadow: titleShadow,
        sunBurstChartPathLabelFont: fontOther,
        sunBurstChartLabelHeaderFillStyle: isDark ? textFillStyle : blackFillStyle,
        sunBurstChartLabelHeaderShadow: isDark ? labelShadow : titleShadow,
        sunBurstChartLabelHeaderFont: fontOther.setWeight('bold'),
        sunBurstChartLabelFillStyle: isDark ? textFillStyle : blackFillStyle,
        sunBurstChartLabelShadow: isDark ? labelShadow : titleShadow,
        sunBurstChartLabelFont: fontOther,
        sunBurstChartNodeBorderStyle: new SolidLine({ thickness: 0.5, fillStyle: new SolidFill({ color: isDark ? ColorRGBA(0, 0, 0, 80) : ColorRGBA(0, 0, 0, 50) }) }),
        ...
        parallelCoordinateChartTitleShadow: titleShadow,
